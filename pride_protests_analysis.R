...
pride <- read.dta("C:/Users/fjoli/Dropbox/200697 Pride and Protests/pride_protests.dta", convert.factors=F)
attach(pride)

pride$treat<-as.factor(treat) 
pride$pride_CL<-as.factor(pride_CL) 
pride$energy <-as.factor(energy)
pride$pride_esf<-as.factor(pride_esf) 
pride$pride_sym <-as.factor(pride_sym)
pride$pride_dev <-as.factor(pride_dev)
pride$pride_pl<-as.factor(pride_pl)


#pride$gender<-as.factor(gender)
#pride$geozone<-as.factor(geozone)
#pride$zone1<-as.factor(zone1)
#pride$zone2<-as.factor(zone2)
#pride$zone3<-as.factor(zone3)
#pride$zone4<-as.factor(zone4)
#pride$edu<-as.factor(edu)
#pride$edu1<-as.factor(edu1)
#pride$edu2<-as.factor(edu2)
#pride$edu3<-as.factor(edu3)
#pride$household<-as.factor(household)
#pride$household1<-as.factor(household1)
#pride$household2<-as.factor(household2)
#pride$household3<-as.factor(household3)
#pride$household4<-as.factor(household4)

prideLW <- pride[ which(sample==1),] #Listwise
detach(pride)
attach(prideLW)
